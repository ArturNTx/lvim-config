...
-- CUSTOMS
-- Insert Mode Cursor Navigation [Custom]
lvim.keys.insert_mode["<C-h>"] = "<Left>"
lvim.keys.insert_mode["<C-j>"] = "<Down>"
lvim.keys.insert_mode["<C-k>"] = "<Up>"
lvim.keys.insert_mode["<C-l>"] = "<Right>"
-- Disable Arrow Keys [Custom]
...
lvim.keys.normal_mode["<S-Down>"] = "<cmd>m +1<CR>"
-- BufferNavigation [Custom]
lvim.keys.normal_mode["<Tab>"] = ":BufferLineCycleNext<CR>"
lvim.keys.normal_mode["<S-Tab>"] = ":BufferLineCyclePrev<CR>"
-- Folders Toggle [Custom]
lvim.keys.normal_mode[","] = "<cmd>normal za<CR>"
-- Get Out Insert Mode Quikly
